...
public record KlijentDto(int Id, string Ime, string Prezime, string KorisnickoIme,
    string Email, string Telefon, decimal Kredit, int MestoId, string Mesto);
...
public record DodajKreditDto(decimal Iznos);